 ...
 */
public class pathLife {

    public void statistics(String basepath, int snapshotNum, String summaryName, String statName) throws IOException {
        ...
        BufferedWriter summary = new BufferedWriter(new FileWriter(basepath+"/" +summaryName));
        ...
        for (int k:watersort) {
            stat.write(String.format("%d\t%d\t%f\n", k, collectWater.get(k).size(), averageLife(collectWater.get(k))));
        }
        stat.close();
